...
public class OmOrderHeaders extends BaseDTO {
     ...
     @Transient
     //表中没有的字段
     private List<OmOrderLines> omOrderLiness;
     @Transient
    ...
    public List<OmOrderLines> getOmOrderLiness() {
        return omOrderLiness;
    }

    public void setOmOrderLiness(List<OmOrderLines> omOrderLiness) {
        this.omOrderLiness = omOrderLiness;
    }
